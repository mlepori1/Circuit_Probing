...
# Directories
results_directory = "../../Results/Probes/Reflexive_An/small-male"

outdir = "./Reflexive_An/small-male"
create_knn_chart(
    results_directory,
...
# Directories
results_directory = "../../Results/Probes/Reflexive_An/small-female"

outdir = "./Reflexive_An/small-female"
create_knn_chart(
    results_directory,
    "Agreement KNN Accuracy",
    outdir,
...
# Directories
results_directory = "../../Results/Probes/Reflexive_An/medium-male"

outdir = "./Reflexive_An/medium-male"
create_knn_chart(
    results_directory,
    "Agreement KNN Accuracy",
    outdir,
...
# Directories
results_directory = "../../Results/Probes/Reflexive_An/medium-female"

outdir = "./Reflexive_An/medium-female"
create_knn_chart(
    results_directory,
    "Agreement KNN Accuracy",
    outdir,

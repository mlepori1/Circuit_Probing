...
# The Following code was taken from amnesic_probing: https://github.com/yanaiela/amnesic_probing/tree/main
...
def read_onto_notes_format(input_file):
    data = []
    for cur_file in tqdm(
        glob.glob(input_file + "/data/english/**/*.*gold_conll", recursive=True)
    ):
